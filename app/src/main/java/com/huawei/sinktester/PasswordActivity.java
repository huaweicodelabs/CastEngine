...
public class PasswordActivity extends AppCompatActivity implements TextWatcher, View.OnFocusChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonFocusDrawable = getResources().getDrawable(R.drawable.svgbutton_selected);
        mButtonUnfocusDrawable = getResources().getDrawable(R.drawable.svgbutton_unselected);
        ...
        mConfirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(mPasswordEditText.getText()) || mPasswordEditText.getText().toString().length()!=6){
                    Toast.makeText(PasswordActivity.this, "" + getResources().getString(R.string.input_digits), Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (checkPassword(password)) {
                    ...
                    Toast.makeText(PasswordActivity.this, getResources().getString(R.string.contain_digits), Toast.LENGTH_LONG).show();
                }
            }
        });
