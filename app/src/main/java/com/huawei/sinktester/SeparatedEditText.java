...
public class SeparatedEditText extends AppCompatEditText {
    ...
    private Paint blockPaint;//实心块画笔 Paint
    private Paint textPaint;
    private Paint cursorPaint;

    private RectF borderRectF;
    private RectF boxRectF;//小方块、小矩形 Block

    private int width;//可绘制宽度 Drawable width
    private int height;//可绘制高度 Drawable height

    private int boxWidth;//方块宽度 Block width
    private int boxHeight;//方块高度 Block height


    private int spacing;//方块之间间隙 Gap between blocks
    private int corner;//圆角 Round corner
    private int maxLength;//最大位数 Maximum number of characters
    private boolean showCursor;//显示光标 Show the cursor
    private int cursorDuration;//光标闪动间隔 Cursor blinking interval
    private int cursorWidth;//光标宽度 Cursor width
    private int cursorColor;//光标颜色 Cursor color
    ...
    protected void onAttachedToWindow() {
        ...
        //cursorFlashTime为光标闪动的间隔时间 cursorFlashTime: duration for which the cursor blinks
    ...
    public interface TextChangedListener {
         ...
         *                   Characters to be input or deleted
         */
